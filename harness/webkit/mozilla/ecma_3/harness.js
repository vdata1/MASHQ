...
function expectExitCode(n) {
  console.log("--- NOTE: IN THIS TESTCASE, WE EXPECT EXIT CODE " + n + " ---");
}
...
function reportFailure(msg) {
  ...
  for (var i = 0; i < lines.length; i++)
    console.log(FAILED + prefix + lines[i]);
}
...
function printStatus(msg) {
  ...
  for (var i = 0; i < lines.length; i++) console.log(STATUS + lines[i]);
}
