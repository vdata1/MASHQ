...
/*
 * Begin console.loging functions.  These functions use the shell's
 * console.log function.  When running tests in the browser, these
...
function DaylightSavingTA(t) {
  ...
  console.log(new Date(UTC(dst_start + LocalTZA())));
...
function GetLastSundayInOctober(t) {
  ...
  for (
    var last_sunday = oct + 30 * msPerDay;
